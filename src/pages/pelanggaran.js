...
class Pelanggaran extends React.Component {
    ...
    handleSave = (event) => {
        ...
        /* menampung data id_pelanggaran, nama_pelanggaran, dan poin dari Form
        ke dalam FormData() untuk dikirim  */
        let url = "";
        if (this.state.action === "insert") {
          url = "http://localhost:2200/pelanggaran/save"
        } else {
          url = "http://localhost:2200/pelanggaran/update"
        }
    ...
    Drop = (id_pelanggaran) => {
        let url = "http://localhost:2200/pelanggaran/" + id_pelanggaran;
